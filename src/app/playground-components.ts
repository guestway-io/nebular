    ...
    children: [
      {
        ...
        link: '/menu-compact/menu-compact-children.component',
        component: 'MenuCompactChildrenComponent',
        name: 'Menu Compact Children',
      },
      {
        path: 'menu-compact-showcase.component',
        link: '/menu-compact/menu-compact-showcase.component',
        component: 'MenuCompactShowcaseComponent',
        name: 'Menu Compact Showcase',
      },
      {
        path: 'menu-compact-autocollapse.component',
        link: '/menu-compact/menu-compact-autocollapse.component',
        component: 'MenuCompactAutoCollapseComponent',
        name: 'Menu Compact Auto Collapse',
      },
      {
        path: 'menu-compact-link-params.component',
        link: '/menu-compact/menu-compact-link-params.component',
        component: 'MenuCompactLinkParamsComponent',
        name: 'Menu Compact Link Params',
      },
      {
        path: 'menu-compact-badge.component',
        link: '/menu-compact/menu-compact-badge.component',
        component: 'MenuCompactBadgeComponent',
        name: 'Menu Compact Badge',
      },
      {
        path: 'menu-compact-service.component',
        link: '/menu-compact/menu-compact-service.component',
        component: 'MenuCompactServiceComponent',
        name: 'Menu Compact Service',
        children: [
          {
            path: '2',
            link: '/menu-compact/menu-compact-service.component/2',
            component: 'MenuCompactServiceItem2Component',
            name: 'Menu Compact Service Item2',
          },
          {
            path: '3',
            link: '/menu-compact/menu-compact-service.component/3',
            component: 'MenuCompactServiceItem3Component',
            name: 'Menu Compact Service Item3',
            children: [
              {
                path: '1',
                link: '/menu-compact/menu-compact-service.component/3/1',
                component: 'MenuCompactServiceItem31Component',
                name: 'Menu Compact Service Item31',
              },
              {
                path: '2',
                link: '/menu-compact/menu-compact-service.component/3/2',
                component: 'MenuCompactServiceItem32Component',
                name: 'Menu Compact Service Item32',
              },
              {
                path: '3',
                link: '/menu-compact/menu-compact-service.component/3/3',
                component: 'MenuCompactServiceItem33Component',
                name: 'Menu Compact Service Item33',
                children: [
                  {
                    path: '1',
                    link: '/menu-compact/menu-compact-service.component/3/3/1',
                    component: 'MenuCompactServiceItem331Component',
                    name: 'Menu Compact Service Item331',
                  },
                  {
                    path: '2',
                    link: '/menu-compact/menu-compact-service.component/3/3/2',
                    component: 'MenuCompactServiceItem332Component',
                    name: 'Menu Compact Service Item332',
                  },
                ],
              },
            ],
    ...
    children: [
      {
        ...
        children: [
          ...
          {
            path: '4',
            link: '/menu-compact/menu-compact-test.component/4',
            component: 'MenuCompactItem4Component',
            name: 'Menu Compact Item4',
          },
        ],
      },
    ],
